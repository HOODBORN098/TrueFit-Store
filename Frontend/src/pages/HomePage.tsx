        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-start text-center text-white px-6 pt-12 pb-[26rem] md:pt-32 md:pb-[32rem]">
              <span className={`inline-block px-4 py-1.5 mb-8 border border-white/30 backdrop-blur-md rounded-full text-xs font-semibold tracking-[0.2em] uppercase transition-all duration-700 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                {slide.subtitle}
              </span>
              <h1 className={`text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter mb-8 font-serif transition-all duration-700 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <p className={`text-lg md:text-xl font-light mb-12 max-w-2xl mx-auto text-white/90 transition-all duration-700 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                {slide.description}
              </p>
              <div className={`flex flex-col sm:flex-row gap-6 transition-all duration-700 ${index === currentSlide ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                <Button
                  variant="white"
                  size="lg"
